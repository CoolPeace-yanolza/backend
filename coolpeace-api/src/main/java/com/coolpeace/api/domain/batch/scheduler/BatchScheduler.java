package com.coolpeace.api.domain.batch.scheduler;

import com.coolpeace.api.domain.batch.job.DailyStatisticsConfig;
import com.coolpeace.api.domain.batch.job.MonthlyStatisticsConfig;
